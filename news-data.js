(function () {
    ...
    {
        slug: '2026-05-21-1',
        title: '우리 회사의 정확한 수익이 얼마인지 잘 모르시나요?',
        category: '경리뉴스',
        date: '2026-05-21',
        summary: '매출은 들어오는데 정작 이번 달에 얼마가 남는지 모르겠다는 대표님들이 많습니다.',
        cover: '',
        url: 'news/2026-05-21-1.html'
    },
        ...
        category: '경리뉴스',
        date: '2026-05-21',
        summary: '법인세 신고 끝나고 나서 \"왜 이렇게 많이 나왔지?\" 싶었던 적 있으신가요?  매출이 늘어서 세금이 오르는 건 어쩔 수 없습니다. 하지만 증빙 누락, 비용 오분류, 공제 항목 미처리 같은 이유로 더 내고 있다면 얘기가 다릅니다.',
        cover: '',
